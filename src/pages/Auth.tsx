...
import { BookOpen, GraduationCap, Users, Mail, Lock, Eye, EyeOff } from 'lucide-react';
import { z } from 'zod';
      ...
      <div className={styles.authContainer}>
        ...
        >
          <div className={styles.authHeader}>
            ...
            <h1 className={styles.authTitle}>Choose Your Role</h1>
            <p className={styles.authSubtitle}>Select how you'll use EduFlow</p>
          </div>
